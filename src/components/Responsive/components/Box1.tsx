...
const Box1 = () => {
	return (
		<div className="md:w-[273px] md:h-[400px] relative w-[354px] h-[340px]">
			<div className="md:w-[273px] md:h-[400px] w-[354px] h-[340px] left-0 top-0 absolute bg-gray-50 rounded-lg border border-[#ECEFF3] md:hidden"></div>
			...
			<div className="left-[20px] md:top-[300px] top-[255px]  absolute flex-col justify-start items-start gap-1 inline-flex ">
